...
public class JVData_Struct
{
    ...
    public struct JV_RA_RACE
    {
        ...
        public RACE_JYOKEN JyokenInfo;      // <競走条件コード>
        public string JyokenName;           // 競走条件名称(地方競馬のみ)
        public string Kyori;                // 距離
    ...
    public struct JV_WC_WOOD
    {
        ...
        public string ChokyoTime;   // 調教時刻
        public string KettoNum;     // 血統登録番号
        public string Cource;       //コース
        public string BabaMawri;    //馬場周り
        public string reserve;      //予備
        public string HaronTime10;   // 10ハロンタイム合計(2000M-0M)
        public string LapTime10;     // ラップタイム(2000M-1800M)
        public string HaronTime9;   // 9ハロンタイム合計(800M-0M)
        public string LapTime9;     // ラップタイム(800M-600M)
        public string HaronTime8;   // 8ハロンタイム合計(800M-0M)
        public string LapTime8;     // ラップタイム(800M-600M)
        public string HaronTime7;   // 7ハロンタイム合計(800M-0M)
        public string LapTime7;     // ラップタイム(800M-600M)
        public string HaronTime6;   // 6ハロンタイム合計(800M-0M)
        public string LapTime6;     // ラップタイム(800M-600M)
        public string HaronTime5;   // 5ハロンタイム合計(800M-0M)
        public string LapTime5;     // ラップタイム(800M-600M)
        public string HaronTime4;   // 4ハロンタイム合計(800M-0M)
        public string LapTime4;     // ラップタイム(800M-600M)
        public string HaronTime3;   // 3ハロンタイム合計(600M-0M)
        public string LapTime3;     // ラップタイム(600M-400M)
        ...
        public void SetDataB(ref string strBuff)
        {
            ...
            ChokyoTime = MidB2S(ref bBuff, 21, 4);
            KettoNum = MidB2S(ref bBuff, 25, 10);
            Cource = MidB2S(ref bBuff, 35, 1);
            BabaMawri = MidB2S(ref bBuff, 36, 1);
            reserve = MidB2S(ref bBuff, 37, 1);
